                ...
                <div class="p-3">
                    <div class="row">
                        <div class="col-9 col-lg-8 col-md-8 col-sm-9">
                            <div>
                                <h5 class="text-capitalize font-weight-bold mb-0">
                        ...
                        <div class="col-3 col-lg-4 col-md-4 col-sm-3 text-end">
                            <div class="icon icon-shape bg-gradient-primary float-end border-radius-md shadow">
                                <img class="w-100" src="{{ asset('admin/images/icon.svg') }}" />
                            </div>
                        </div>
                    </div>
                </div>
